...
<v-container fluid class="ma-0 pa-0 overflow-hidden">
  ...
  <v-container fluid>
    <v-dialog
      ...
      width="300px"
    >
      <Leaderboard :players="players" :headers="headers"></Leaderboard>
  ...
  <v-row style="border:2px solid black;background-color:#1d4e38;" ref="deal" class="justify-center">
    ...
    <v-card 
      v-for="(cards, index) in dealerHand"
      :key="index"
      width="80px"
      height="120px"
      light
    ...
    <v-col class="d-flex flex-column">
      <v-row class="align-center">
        {{cards.number}}
        <v-icon x-small :color="cards.color">{{ cards.icon }}</v-icon>
      </v-row>
      <v-row class="justify-center">
        <v-icon x-large :color="cards.color">{{ cards.icon }}</v-icon>
      </v-row>
      <v-row class="flex-row-reverse align-center">
        {{cards.number}}
        <v-icon x-small :color="cards.color">{{ cards.icon }}</v-icon>
